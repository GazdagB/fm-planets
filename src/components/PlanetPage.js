...
const PlanetPage = ({ planetNumber, mobileIsOpen, setMobileIsOpen}) => {
    ...
    return (
        ...
        { mobileIsOpen && <div className="mobile-menu">
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/">mercury</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/venus">venus</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/earth">earth</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/mars">mars</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/jupiter">jupiter</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/saturn">saturn</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/uranus">uranus</Link>
            <Link onClick={()=>{setMobileIsOpen(false)}} className="li" to="/neptune">neptune</Link>
        </div>}
        </>
    );
};
